...
def open_nrc_sentiment(file="/home/garcia/Escritorio/hp-emo-main/lexicons/NRC-Hashtag-Sentiment-Lexicon-v0.1/unigrams-pmilexicon.txt.gz"):
    lex = {}
...
def open_nrc_emotion(file="/home/garcia/Escritorio/hp-emo-main/lexicons/lexicons/NRC-emotion-lexicon-wordlevel-v0.92.txt.gz"):
    lex = {}
    for line in gzip.open(file, mode="r"):
        line = line.decode()
...
def open_nrc_hashtag(file="/home/garcia/Escritorio/hp-emo-main/lexicons/lexicons/NRC-Hashtag-Emotion-Lexicon-v0.2.txt.gz"):
    lex = {}
